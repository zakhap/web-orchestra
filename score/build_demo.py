...
CELLS = [
    # ---- A: home -----------------------------------------------------------
    (1,  "A", 4, [(8,0,3.5)]),
    (2,  "A", 2, [(8,0,.5),(9,.5,.5),(8,1,1)]),
    (3,  "A", 3, [(8,0,.5),(9,.5,.5),(10,1,.5),(9,1.5,.5),(8,2,1)]),
    (4,  "A", 4, [(12,0,1),(10,1,1),(9,2,1),(8,3,1)]),
    (5,  "A", 2, [(6,0,1),(8,1,1)]),
    (6,  "A", 6, [(8,0,1),(10,1,1),(12,2,2),(10,4,1),(8,5,1)]),
    # ---- B: the seventh arrives --------------------------------------------
    (7,  "B", 4, [(8,0,.5),(9,.5,.5),(10,1,.5),(14,1.5,2.5)]),
    (8,  "B", 2, [(14,0,1),(12,1,1)]),
    (9,  "B", 3, [(7,0,1.5),(8,1.5,1.5)]),
    (10, "B", 6, [(12,0,1),(14,1,2),(16,3,3)]),
    (11, "B", 4, [(14,0,4)]),
    (12, "B", 8, [(10,0,1),(12,1,1),(14,2,2),(12,4,1),(10,5,1),(8,6,2)]),
    # ---- C: 11 and 13 ------------------------------------------------------
    (13, "C", 4, [(11,0,4)]),
    (14, "C", 3, [(10,0,.5),(11,.5,1),(12,1.5,.5),(11,2,1)]),
    (15, "C", 4, [(11,0,2),(13,2,2)]),
    (16, "C", 8, [(8,0,2),(11,2,2),(13,4,2),(16,6,2)]),
    (17, "C", 4, [(13,0,1),(12,1,1),(11,2,1),(10,3,1)]),
    (18, "C", 2, [(22,0,1),(11,1,1)]),
    # ---- D: retreat, and close the ring ------------------------------------
    (19, "D", 3, [(11,0,1),(10,1,1),(9,2,1)]),
    (20, "D", 6, [(14,0,2),(12,2,2),(10,4,2)]),
    (21, "D", 3, [(10,0,1),(9,1,1),(8,2,1)]),
    (22, "D", 4, [(12,0,1),(10,1,1),(8,2,2)]),
    (23, "D", 2, [(8,0,.5),(9,.5,.5),(8,1,1)]),        # echoes cell 2
    (24, "D", 4, [(8,0,3.5)]),                          # echoes cell 1 — SEAM
]
